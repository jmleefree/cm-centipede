-- Matrix source seed - MariaDB
--
-- The SQL below is currently identical to seed-mysql.sql, and the duplication is
-- deliberate. Finding where the two engines diverge is what this matrix is for,
-- and a shared file removes the place to express a divergence once one appears.
--
...
-- an event. The multibyte rows are the charset check.
--
-- Loaded by scripts/init-mariadb.sh, inside the database it created.
