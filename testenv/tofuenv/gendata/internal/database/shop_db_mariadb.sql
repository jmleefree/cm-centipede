...
CREATE OR REPLACE FUNCTION fn_format_krw(p_amount DECIMAL(12,2))
RETURNS VARCHAR(50)
DETERMINISTIC
BEGIN
...
CREATE OR REPLACE FUNCTION fn_calc_discounted_total(p_order_id INT)
RETURNS DECIMAL(12,2)
READS SQL DATA
BEGIN
...
CREATE OR REPLACE PROCEDURE sp_update_customer_grade(IN p_customer_id INT)
BEGIN
...
CREATE OR REPLACE EVENT evt_cleanup_inventory_logs
...
CREATE OR REPLACE EVENT evt_auto_cancel_stale_orders
...
CREATE OR REPLACE EVENT evt_recalculate_customer_grades
ON SCHEDULE EVERY 1 DAY
