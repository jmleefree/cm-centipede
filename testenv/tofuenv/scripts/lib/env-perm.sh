...
# ------------------------------------------------------------------------------
#   Sourced by the two host-side entry points that read .env directly:
#   scripts/up.sh and init/openbao/register-creds.sh (which scripts/
#   register-creds.sh execs into).
#
...
#   .env for good. Anything that can read the file can read every stored
#   credential through it, so the file mode is the whole protection.
#
