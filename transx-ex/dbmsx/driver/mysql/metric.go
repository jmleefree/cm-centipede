...
// mysqlMetric resolves loc.Metric.MySQL into concrete flags (all default false).
func mysqlMetric(loc base.DBMSLocation) sqlInspectMetric {
	if loc.Metric == nil || loc.Metric.MySQL == nil {
